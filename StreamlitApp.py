...
def selling_price():
    ...
    if button:
        ...
        file_path = 'regression_model.joblib'  # Adjust the file path as per your saved model
...
def status():
    ...
    if button:
        # Convert quantity to string       
        file_path = 'class_model.joblib'  # Adjust the file path as per your saved model
